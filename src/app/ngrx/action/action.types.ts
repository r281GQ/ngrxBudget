...
export const PERSIST_EQUITY: string = 'persistEquity';
export const REMOVE_EQUITY: string = 'removeEquity';
export const REFRESH_EQUITY: string = 'refreshEquity';

export const CREATE_EQUITY: string = 'createEquity';
export const UPDATE_EQUITY: string = 'updateEquity';
